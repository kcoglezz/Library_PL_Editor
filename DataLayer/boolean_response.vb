...
Namespace DataLayer
    ...
    Public Class boolean_response

        '*********************************************************************
        '  Class Name: boolean_response
...
#Region "Methods"
        ...
        Public Sub getByID(ByVal intId As Integer)
            ...
            Dim strCacheVar As String = "objCachedDbBooleanResponse" & intId
            ...
            If IsNothing(HttpContext.Current.Cache.Get(strCacheVar)) Then
                ...
                Try
                    ...
                    reader = ParaLideres.GenericDataHandler.GetRecords("proc_GetBooleanResponseByID " & intId)
        ...
        Public Sub Delete(ByVal intId As Integer)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_DeleteBooleanResponse " & intId)
        ...
        Public Sub Add(ByVal strValue As String)

            Dim intId As Integer = 0

            Try

                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertBooleanResponse '" & strValue & "'"))
        ...
        Public Sub Add()
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertBooleanResponse '" & _strValue & "'"))
        ...
        Public Sub Update(ByVal intId As Integer, ByVal strValue As String)

            Try

                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateBooleanResponse " & intId & ",'" & strValue & "'")
        ...
        Public Sub Update()
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateBooleanResponse " & _intId & ",'" & _strValue & "'")
        ...
        Public Sub UpdateCache()
            ...
            Dim objCached As DataLayer.boolean_response

            Dim strCacheVar As String = "objCachedDbBooleanResponse" & _intId

            Try

                HttpContext.Current.Cache.Remove(strCacheVar)

                objCached = New DataLayer.boolean_response

                objCached.setId(_intId)

                objCached.setValue(_strValue)
