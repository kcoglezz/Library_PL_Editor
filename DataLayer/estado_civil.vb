...
#Region "Methods"
        ...
        Public Sub getByID(ByVal intId As Integer)
            ...
            Dim strCacheVar As String = "objCachedDbEstadoCivil" & intId
            ...
            If IsNothing(HttpContext.Current.Cache.Get(strCacheVar)) Then
                ...
                Try
                    ...
                    reader = ParaLideres.GenericDataHandler.GetRecords("proc_GetEstadoCivilByID " & intId)
        ...
        Public Sub Delete(ByVal intId As Integer)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_DeleteEstadoCivil " & intId)
        ...
        Public Sub Add(ByVal strDescription As String)
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertEstadoCivil '" & strDescription & "'"))
        ...
        Public Sub Add()
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertEstadoCivil '" & _strDescription & "'"))
        ...
        Public Sub Update(ByVal intId As Integer, ByVal strDescription As String)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateEstadoCivil " & intId & ",'" & strDescription & "'")
        ...
        Public Sub Update()
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateEstadoCivil " & _intId & ",'" & _strDescription & "'")
        ...
        Public Sub UpdateCache()
            ...
            Dim objCached As DataLayer.estado_civil

            Dim strCacheVar As String = "objCachedDbEstadoCivil" & _intId

            Try

                HttpContext.Current.Cache.Remove(strCacheVar)

                objCached = New DataLayer.estado_civil
