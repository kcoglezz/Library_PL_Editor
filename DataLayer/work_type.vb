...
#Region "Methods"
        ...
        Public Sub getByID(ByVal intId As Integer)
            ...
            Dim strCacheVar As String = "objCachedDbWorkType" & intId
            ...
            If IsNothing(HttpContext.Current.Cache.Get(strCacheVar)) Then
                ...
                Try
                    ...
                    reader = ParaLideres.GenericDataHandler.GetRecords("proc_GetWorkTypeByID " & intId)
        ...
        Public Sub Delete(ByVal intId As Integer)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_DeleteWorkType " & intId)
        ...
        Public Sub Add(ByVal strDescription As String)
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertWorkType '" & strDescription & "'"))
        ...
        Public Sub Add()
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertWorkType '" & _strDescription & "'"))
        ...
        Public Sub Update(ByVal intId As Integer, ByVal strDescription As String)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateWorkType " & intId & ",'" & strDescription & "'")
        ...
        Public Sub Update()
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateWorkType " & _intId & ",'" & _strDescription & "'")
        ...
        Public Sub UpdateCache()
            ...
            Dim objCached As DataLayer.work_type

            Dim strCacheVar As String = "objCachedDbWorkType" & _intId

            Try

                HttpContext.Current.Cache.Remove(strCacheVar)

                objCached = New DataLayer.work_type
