...
#Region "Methods"
        ...
        Public Sub getByID(ByVal intId As Integer)
            ...
            Dim strCacheVar As String = "objCachedDbSexo" & intId
            ...
            If IsNothing(HttpContext.Current.Cache.Get(strCacheVar)) Then
                ...
                Try
                    ...
                    reader = ParaLideres.GenericDataHandler.GetRecords("proc_GetSexoByID " & intId)
        ...
        Public Sub Delete(ByVal intId As Integer)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_DeleteSexo " & intId)
        ...
        Public Sub Add(ByVal strDescription As String)
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertSexo '" & strDescription & "'"))
        ...
        Public Sub Add()
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertSexo '" & _strDescription & "'"))
        ...
        Public Sub Update(ByVal intId As Integer, ByVal strDescription As String)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateSexo " & intId & ",'" & strDescription & "'")
        ...
        Public Sub Update()
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateSexo " & _intId & ",'" & _strDescription & "'")
        ...
        Public Sub UpdateCache()
            ...
            Dim objCached As DataLayer.sexo

            Dim strCacheVar As String = "objCachedDbSexo" & _intId

            Try

                HttpContext.Current.Cache.Remove(strCacheVar)

                objCached = New DataLayer.sexo
