...
#Region "Methods"
        ...
        Public Sub getByID(ByVal intId As Integer)
            ...
            Dim strCacheVar As String = "objCachedDbPageType" & intId
            ...
            If IsNothing(HttpContext.Current.Cache.Get(strCacheVar)) Then
                ...
                Try
                    ...
                    reader = ParaLideres.GenericDataHandler.GetRecords("proc_GetPageTypeByID " & intId)
        ...
        Public Sub Delete(ByVal intId As Integer)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_DeletePageType " & intId)
        ...
        Public Sub Add(ByVal strValue As String)
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertPageType '" & strValue & "'"))
        ...
        Public Sub Add()
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertPageType '" & _strValue & "'"))
        ...
        Public Sub Update(ByVal intId As Integer, ByVal strValue As String)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdatePageType " & intId & ",'" & strValue & "'")
        ...
        Public Sub Update()
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdatePageType " & _intId & ",'" & _strValue & "'")
        ...
        Public Sub UpdateCache()
            ...
            Dim objCached As DataLayer.page_type

            Dim strCacheVar As String = "objCachedDbPageType" & _intId

            Try

                HttpContext.Current.Cache.Remove(strCacheVar)

                objCached = New DataLayer.page_type
