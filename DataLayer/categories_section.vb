...
Namespace DataLayer
    ...
    Public Class categories_section

        '*********************************************************************
        '  Class Name: categories_section
...
#Region "Methods"
        ...
        Public Sub getByID(ByVal intId As Integer)
            ...
            Dim strCacheVar As String = "objCachedDbCategoriesSection" & intId
            ...
            If IsNothing(HttpContext.Current.Cache.Get(strCacheVar)) Then
                ...
                Try
                    ...
                    reader = ParaLideres.GenericDataHandler.GetRecords("proc_GetCategoriesSectionByID " & intId)
        ...
        Public Sub Delete(ByVal intId As Integer)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_DeleteCategoriesSection " & intId)
        ...
        Public Sub Add(ByVal strDescription As String)
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertCategoriesSection '" & strDescription & "'"))
        ...
        Public Sub Add()
            ...
            Try
                ...
                intId = CInt(ParaLideres.GenericDataHandler.ExecScalar("proc_InsertCategoriesSection '" & _strDescription & "'"))
        ...
        Public Sub Update(ByVal intId As Integer, ByVal strDescription As String)
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateCategoriesSection " & intId & ",'" & strDescription & "'")
        ...
        Public Sub Update()
            ...
            Try
                ...
                ParaLideres.GenericDataHandler.ExecSQL("proc_UpdateCategoriesSection " & _intId & ",'" & _strDescription & "'")
        ...
        Public Sub UpdateCache()
            ...
            Dim objCached As DataLayer.categories_section

            Dim strCacheVar As String = "objCachedDbCategoriesSection" & _intId

            Try

                HttpContext.Current.Cache.Remove(strCacheVar)

                objCached = New DataLayer.categories_section
